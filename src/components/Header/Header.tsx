...
const Header = () => {
    ...
    return (
        <header className="flex items-center justify-between dark:bg-gray-800 py-2 px-2 relative bg-gray-100 border-b border-black border-opacity-25 dark:text-white">
            ...
            <ul className={`text-gray-800 dark:text-white dark:bg-gray-800 flex items-start justify-start flex-wrap gap-2 max-md:flex-col max-md:absolute max-md:top-12 max-md:right-0 max-md:p-4 max-md:h-[100vh]  ${click ? "max-sm:hidden" : ""
                }`}>
                {/*  */}
